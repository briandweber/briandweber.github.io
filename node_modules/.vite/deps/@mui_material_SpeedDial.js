...
import {
  Transition_default
} from "./chunk-ABINJIDI.js";
import "./chunk-WV2JNGAC.js";
import {
  init_useForkRef,
  useForkRef_default
...
var _excluded2 = ["ref"];
var _excluded22 = ["ariaLabel", "FabProps", "children", "className", "direction", "hidden", "icon", "onBlur", "onClose", "onFocus", "onKeyDown", "onMouseEnter", "onMouseLeave", "onOpen", "open", "openIcon", "TransitionComponent", "transitionDuration", "TransitionProps"];
var _excluded3 = ["ref"];
...
var SpeedDial = React2.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded2), other = _objectWithoutPropertiesLoose(props, _excluded22);
  ...
  const focusedAction = React2.useRef(0);
  const nextItemArrowKey = React2.useRef();
  const actions = React2.useRef([]);
  actions.current = [actions.current[0]];
  const handleOwnFabRef = React2.useCallback((fabFef) => {
  ...
  const allItems = React2.Children.toArray(childrenProp).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime3.jsxs)(SpeedDialRoot, _extends({
    ...
    children: [(0, import_jsx_runtime2.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime2.jsx)(SpeedDialFab, _extends({
        color: "primary",
        ...
        ref: handleFabRef,
        ownerState,
        children: React2.isValidElement(icon) && isMuiElement_default(icon, ["SpeedDialIcon"]) ? React2.cloneElement(icon, {
          open
        }) : icon
      }))
    })), (0, import_jsx_runtime2.jsx)(SpeedDialActions, {
      id: `${id}-actions`,
      role: "menu",
...
true ? SpeedDial.propTypes = {
   ...
   */
  ariaLabel: import_prop_types2.default.string.isRequired,
  /**
   ...
   * @default {}
   */
  FabProps: import_prop_types2.default.object,
  /**
   ...
   */
  openIcon: import_prop_types2.default.node,
  /**
...
//# sourceMappingURL=@mui_material_SpeedDial.js.map
