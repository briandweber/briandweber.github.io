...
import {
  Fab_default
} from "./chunk-6M3CO5ZC.js";
import {
  Grow_default
} from "./chunk-WEX4FNHI.js";
import "./chunk-TJ4WWSAQ.js";
import {
  Popper
} from "./chunk-ESTUYOLA.js";
import "./chunk-NMDRVMPM.js";
import {
  appendOwnerState
} from "./chunk-SFHLUUGM.js";
import {
  init_useId,
  useId_default
} from "./chunk-HHSSQPTV.js";
import {
  init_useControlled,
  useControlled_default
} from "./chunk-LCBDQKWG.js";
import "./chunk-YC26CCAE.js";
...
import "./chunk-RB56XCW2.js";
import "./chunk-FZ7YHIBY.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-VUDUCLLK.js";
import {
  useRtl
} from "./chunk-ADK5QZB3.js";
...
var _excluded3 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialActionFab = styled_default(Fab_default, {
  ...
  "&:hover": {
    backgroundColor: theme.vars ? theme.vars.palette.SpeedDialAction.fabHoverBg : (0, import_colorManipulator2.emphasize)(theme.palette.background.paper, 0.15)
  },
...
var SpeedDialAction = React3.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React3.useState(tooltipOpenProp);
  ...
  const fab = (0, import_jsx_runtime4.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime5.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
      className: classes.staticTooltip,
      ownerState
    }, other, {
      children: [(0, import_jsx_runtime4.jsx)(SpeedDialActionStaticTooltipLabel, {
        style: transitionStyle,
        id: `${id}-label`,
        className: classes.staticTooltipLabel,
        ownerState,
        children: tooltipTitle
      }), React3.cloneElement(fab, {
  ...
  return (0, import_jsx_runtime4.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
true ? SpeedDialAction.propTypes = {
   ...
   */
  TooltipClasses: import_prop_types3.default.object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: import_prop_types3.default.bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: import_prop_types3.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: import_prop_types3.default.node
} : void 0;
